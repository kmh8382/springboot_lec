...
// 양방향 관계에서 Category 엔티티가 주인 아닌 엔티티입니다.
// 따라서, 해당 Category 엔티티는 주인 엔티티인 Menu 를 참조하고 있음을 명시해야 합니다.
...
public class Category {
  ...
  // 주인이 아닌 엔티티의 toString() 오버라이트 시
  // 주인 엔티티의 출력 구문은 제거해야 합니다.
  // 그렇지 않으면 StackOverflowError 가 방생합니다. (메소드 무한 호출)
  @Override
