...
class A_EntityManagerLifeCycleTests {
  ...
  void closeEntityManager() throws Exception {
	...
	@Test
	void lifr_cycle_test_1() {
	  System.out.println("1 EntityManagerFactory: " + emf.hashCode());
	  System.out.println("1 EntityManager: " + em.hashCode());
	}
	
	@Test
	void lifr_cycle_test_2() {
	  System.out.println("2 EntityManagerFactory: " + emf.hashCode());
	  System.out.println("2 EntityManager: " + em.hashCode());
	}

	 @Test
	  void lifr_cycle_test_3() {
	    System.out.println("3 EntityManagerFactory: " + emf.hashCode());
	    System.out.println("3 EntityManager: " + em.hashCode());
	  }
