...
public class UserController {
  ...
  @ApiResponses(value = {
    ...
    , @ApiResponse(responseCode = "01", description = "필수 입력 값이 누락", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))
...
//""")))      
  ...
  @ApiResponses(value = {
    ...
    , @ApiResponse(responseCode = "01", description = "필수 입력 값이 누락", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))
    , @ApiResponse(responseCode = "02", description = "크기를 벗어난 값 입력", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class))) 
    , @ApiResponse(responseCode = "404", description = "해당 회원 데이터 없음", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))      
  })    
  ...
  @Operation(summary = "회원 정보 삭제", description = " 회원을 삭제하는 기능입니다.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "204", description = "회원 정보 삭제 성공", content = @Content(schema = @Schema(implementation = ResponseMessage.class)))
    , @ApiResponse(responseCode = "03", description = "잘못된 타입의 데이터 입력", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))
    , @ApiResponse(responseCode = "404", description = "해당 회원 데이터 없음", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))
    , @ApiResponse(responseCode = "05", description = "필요한 정보가 누락", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))      
  })    
  ...
  @ApiResponses(value = {
    ...
    , @ApiResponse(responseCode = "06", description = "잘못된 요청 파라미터", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))
    , @ApiResponse(responseCode = "07", description = "파라미터 sort의 값이 잘못 전달", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))      
  })
  @Parameters(value = {
  ...
  @Operation(summary = "회원 상세 조회", description = " 회원 상세 내역을 조회하는 기능입니다.")
  @ApiResponses(value = {
      @ApiResponse(responseCode = "200", description = "회원 목록 조회 성공", content = @Content(schema = @Schema(implementation = ResponseMessage.class)))
    , @ApiResponse(responseCode = "404", description = "해당 회원 데이터 없음", content = @Content(schema = @Schema(implementation = ResponseErrorMessage.class)))      
  })  
