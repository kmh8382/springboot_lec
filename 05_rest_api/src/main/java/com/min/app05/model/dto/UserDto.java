...
public class UserDto {
  ...
  @NotBlank(message = "이메일은 반드시 입력해야 합니다.")  // null, 빈 문자열(""), 공백 문자(" ") 모두 체크 가능합니다.
  @Size(max = 100, message = "이메일의 최대 글자 수는 100자입니다.")  // @Min, @Max 로 사용 가능
  private String email;         // NOT NULL
  
  @Size(min = 4, max = 100, message = "비밀번호는 4 ~ 20자입니다.")
  private String pwd;
